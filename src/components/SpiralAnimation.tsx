...
class AnimationController {
    ...
    // Theme colors (gold/amber matching the app theme)
    private readonly primaryColor = 'hsl(37, 92%, 50%)' // Primary amber/gold
    private readonly trailColor = 'hsl(43, 96%, 56%)' // Chart-3 gold
    private readonly starColor = 'hsl(45, 96%, 64%)' // Chart-1 lighter gold
    private readonly bgColor = 'hsl(24, 9%, 10%)' // Dark background
    ...
    public render() {
        ...
        // Draw start dot with primary color
