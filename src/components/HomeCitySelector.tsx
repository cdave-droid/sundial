        ...
        <div className="w-full max-w-md">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-12 pr-4 h-14 text-lg bg-card/90 backdrop-blur-md border-primary/30 shadow-xl rounded-xl focus:ring-2 focus:ring-primary/50"
              autoFocus
              autoComplete="off"
            />
            ...
            {isOpen && filteredCities.length > 0 && (
              <div 
                ref={dropdownRef}
                className="absolute top-full left-0 right-0 mt-2 bg-card/95 backdrop-blur-md border border-border/50 rounded-xl shadow-2xl overflow-hidden z-50"
              >
