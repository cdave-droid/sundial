  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-9 w-9 p-0 font-normal aria-selected:opacity-100 text-white hover:bg-zinc-700 hover:text-white"),
        day_range_end: "day-range-end",
        day_selected:
          "bg-amber-500 text-zinc-900 hover:bg-amber-400 hover:text-zinc-900 focus:bg-amber-500 focus:text-zinc-900",
